...
public class Loader {
	...
	public static void load() {
		...
		Images.add(APPLE, new ImageIcon("C:\\Users\\plath\\Documents\\Unicamp\\7º semestre\\MC322\\LabDupla\\TrabalhosMC\\ProjetoFinal\\src\\images\\apple.png"));
				//Loader.class.getResource(".").getPath() + "apple.png"));
